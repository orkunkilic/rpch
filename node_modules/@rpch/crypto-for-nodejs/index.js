...
* @returns {Session}
*/
module.exports.box_request = function(request, exit_node) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(request, Envelope);
        var ptr0 = request.ptr;
        request.ptr = 0;
        _assertClass(exit_node, Identity);
        wasm.box_request(retptr, ptr0, exit_node.ptr);
...
* @returns {Session}
*/
module.exports.unbox_request = function(message, my_id, client_last_request_ts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(message, Envelope);
        var ptr0 = message.ptr;
        message.ptr = 0;
        _assertClass(my_id, Identity);
        wasm.unbox_request(retptr, ptr0, my_id.ptr, client_last_request_ts);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
*/
module.exports.box_response = function(session, response) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(session, Session);
        _assertClass(response, Envelope);
        var ptr0 = response.ptr;
        response.ptr = 0;
        wasm.box_response(retptr, session.ptr, ptr0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
*/
module.exports.unbox_response = function(session, message, exit_last_response_ts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(session, Session);
        _assertClass(message, Envelope);
        var ptr0 = message.ptr;
        message.ptr = 0;
        wasm.unbox_response(retptr, session.ptr, ptr0, exit_last_response_ts);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
class Envelope {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Envelope.prototype);
        obj.ptr = ptr;
    ...
    */
    constructor(message, entry_peer_id, exit_peer_id) {
        const ptr0 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(entry_peer_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(exit_peer_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.envelope_new(ptr0, len0, ptr1, len1, ptr2, len2);
        return Envelope.__wrap(ret);
    }
}
...
class Identity {
    ...
    * @returns {Identity}
    */
    static load_identity(public_key, private_key) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            ...
            wasm.identity_load_identity(retptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
class Session {
    ...
    */
    get_request_data() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.session_get_request_data(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
    ...
    */
    get_response_data() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.session_get_response_data(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    */
    updated_counter() {
        const ret = wasm.session_updated_counter(this.ptr);
